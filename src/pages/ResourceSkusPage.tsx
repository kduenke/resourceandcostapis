...
const apiDef = getApiById('resource-skus')!;

export function ResourceSkusPage() {
  ...
  const fields: ParameterField[] = [
    {
      ...
      description: 'The Azure subscription to query resource SKUs for.',
      required: true,
    ...
    },
    {
      ...
      description: "Filter SKUs (e.g., location eq 'eastus' or resourceType eq 'virtualMachines')",
      required: false,
      type: 'text',
  ...
  const handleSubmit = useCallback(async () => {
    ...
    await execute(apiDef, { subscriptionId }, queryOverrides);
